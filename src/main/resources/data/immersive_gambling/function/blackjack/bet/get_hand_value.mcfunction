...
function immersive_gambling:blackjack/click/execute_as_type_in_group_no_tag {type: "card_slot", cmd: "function immersive_gambling:blackjack/card/get_value"}
...
function immersive_gambling:blackjack/click/execute_as_type_in_group_no_tag {type: "hand_value", cmd: "function immersive_gambling:blackjack/hand_value/set_text"}
tag @s remove 777.store_num

execute if score @s ig.bj.hand_value matches 22.. run function immersive_gambling:blackjack/bet/bust/start