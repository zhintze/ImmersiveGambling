# Reward player for blackjack (2.5x payout - 3:2 odds)
# Handles stacked bets
# Formula: (bet * 5) / 2 for 2.5x multiplier
...
# Calculate reward (2.5x bet = bet * 5 / 2)
scoreboard players operation #spawn_remaining ig.math_temp = #bet_count ig.math_temp
scoreboard players set #multiplier ig.math_temp 5
scoreboard players operation #spawn_remaining ig.math_temp *= #multiplier ig.math_temp
scoreboard players set #divisor ig.math_temp 2
scoreboard players operation #spawn_remaining ig.math_temp /= #divisor ig.math_temp
