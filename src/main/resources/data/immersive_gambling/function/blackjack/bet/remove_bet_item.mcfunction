...
execute unless data entity @s item{count:1,id:"minecraft:barrier"} run summon item ~ ~0.2 ~ {PickupDelay:2,Motion:[0.0,0.2,0.0],Tags:["new"],Item:{id:"minecraft:stone",count:1}}
